 ...
 */
  ...
  */
	...
	$text['category'] = 'Categoría "%s"'; // text for a category page
	$text['search']   = 'Resultados de búsqueda para "%s"'; // text for a search results page
	$text['tag']      = 'Articulos etiqueta "%s"'; // text for a tag page
	$text['author']   = 'Articulos publicados por %s'; // text for an author page
	$text['404']      = 'Error 404'; // text for the 404 page
	$text['page']     = 'Página %s'; // text 'Page N'
	$text['cpage']    = 'Página de comentarios %s'; // text 'Comment Page N'

	$wrap_before    = '<div><nav aria-label="breadcrumb" class="container-xxl py-2"><ol class="breadcrumb m-0" itemscope itemtype="http://schema.org/BreadcrumbList">'; // the opening wrapper tag
	...
	if ( is_home() || is_front_page() ) {
		...
		if ( is_category() ) {
			...
			if ( get_post_type() != 'post' && get_post_type() != 'event' && get_post_type() != 'article' && get_post_type() != 'multimedia' ) {
				$position += 1;
